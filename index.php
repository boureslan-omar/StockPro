...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div class="d-flex align-items-center gap-3">
        ...
        <img src="/stockpro/assets/img/logo.png" alt="logo" style="height:52px;width:52px;object-fit:contain">
        <?php endif; ?>
        <div>
...
<div class="alert alert-light border d-flex align-items-center justify-content-between py-2 mb-3">
    ...
    <a href="/stockpro/pages/settings.php" class="btn btn-sm btn-outline-secondary">Update Rate</a>
</div>
...
<div class="row g-3">
    ...
    <div class="col-lg-4">
        ...
        <div class="card stat-card p-3 border-danger">
            ...
            <?php endforeach; ?>
            <a href="/stockpro/pages/customers.php" class="btn btn-sm btn-outline-danger w-100 mt-2">View All</a>
        </div>
        <?php endif; ?>
    </div>
