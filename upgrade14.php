...
try {
    ...
    if (strpos($lay, 'pos.css?v=') === false) {
        $lay = str_replace(
            '<link rel="stylesheet" href="/stockpro/assets/css/pos.css">',
    ...
    echo '<nav class="navbar navbar-expand-lg navbar-dark px-3 no-print" style="background:linear-gradient(135deg,var(--brand-dark) 0%,var(--brand) 100%);box-shadow:0 2px 12px rgba(0,0,0,.4)">
        <a class="navbar-brand fw-bold d-flex align-items-center" href="/stockpro/">'
        . $logo
...
<div class="card shadow-sm p-4">
  ...
  <a href="/stockpro/" class="btn btn-primary mt-3">Go to Dashboard</a>
</div>
</div>
</body>
</html>
