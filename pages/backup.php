...
<div class="card stat-card p-4 mb-4">
    ...
    <pre class="bg-dark text-white rounded p-3 small mb-2" style="overflow-x:auto">schtasks /create /tn "MarketPOS_Backup" /tr "\"C:\xampp\php\php.exe\" \"C:\xampp\htdocs\stockpro\backup_cron.php\"" /sc daily /st 02:00 /ru SYSTEM /f</pre>
    <div class="form-text">This runs a silent backup every night at 2:00 AM. A log is saved to <code>C:\xampp\htdocs\stockpro\backup_cron.log</code>.</div>
    <div class="mt-2">
        <a href="/stockpro/backup_cron.log" target="_blank" class="btn btn-sm btn-outline-secondary">
...
function restoreBackup(filename, dateLabel) {
    ...
    fetch('/stockpro/pages/backup.php', {
        method: 'POST',
