...
<div class="card shadow p-4">
  ...
  <div class="text-center mb-4">
    ...
    <img src="/stockpro/assets/img/logo.png" style="height:64px;object-fit:contain"><br>
    <?php endif; ?>
  ...
  <?php if ($success): ?>
    ...
    <a href="/stockpro/login.php" class="btn btn-success w-100 py-2 fw-bold">
