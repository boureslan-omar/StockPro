...
function checkBatch(i) {
    ...
    fetch(`/stockpro/pages/api.php?action=check_batch&product_id=${pid}&cost=${cost}`)
        .then(r => r.json())
        .then(d => {
...
function saveQuickProduct() {
    ...
    fetch('/stockpro/pages/api.php?action=create_product_quick', { method:'POST', body })
        .then(r => r.json())
        .then(d => {
...
function viewPurchase(id, ref) {
    ...
    fetch('/stockpro/pages/api.php?action=purchase_items&id=' + id)
        .then(r => r.json())
        .then(data => {
...
function editPurchase(id, ref) {
    ...
    fetch('/stockpro/pages/api.php?action=get_purchase_for_edit&id=' + id)
        .then(r => r.json())
        .then(data => {
...
function submitPurchaseEdit() {
    ...
    fetch('/stockpro/pages/api.php?action=edit_purchase', { method:'POST', body })
        .then(r => r.json())
        .then(d => {
