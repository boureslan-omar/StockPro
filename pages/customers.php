...
function toggleReceiptItems(saleId, btn) {
    ...
    fetch('/stockpro/pages/api.php?action=sale_items_for_return&sale_id=' + saleId)
        .then(r => r.json())
        .then(items => {
...
function editSale(id, receipt) {
    ...
    fetch('/stockpro/pages/api.php?action=get_sale_for_edit&sale_id=' + id)
        .then(r => r.json())
        .then(data => {
...
function submitEditSale() {
    ...
    fetch('/stockpro/pages/api.php?action=edit_sale', { method:'POST', body })
        .then(r => r.json())
        .then(d => {
...
function printReceipt(saleId) {
    ...
    modal.show();
    fetch('/stockpro/pages/api.php?action=sale_receipt&sale_id=' + saleId)
        .then(r => r.json())
        .then(s => {
