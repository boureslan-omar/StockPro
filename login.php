...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username && $password) {
        ...
        if ($user && password_verify($password, $user['password_hash'])) {
            ...
            $redirect = $_GET['redirect'] ?? '/stockpro/';
...
<div class="login-card">
    <div class="brand-header">
        <?php if ($logoExists): ?>
        <img src="/stockpro/assets/img/logo.png" alt="logo" style="height:72px;width:72px;object-fit:contain;margin-bottom:.75rem;border-radius:8px;background:#fff;padding:4px"><br>
        <?php else: ?>
