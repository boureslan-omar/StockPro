...
<link rel="stylesheet" href="/stockpro/assets/css/pos.css?v=' . filemtime(__DIR__.'/../assets/css/pos.css') . '">
<script>
...
function renderNav($active = '') {
    ...
    $allPages = [
        'dashboard'      => ['icon'=>'bi-speedometer2',    'label'=>'Dashboard',       'url'=>'/stockpro/',                              'roles'=>['admin','cashier','stock']],
        'pos'            => ['icon'=>'bi-cart3',            'label'=>'POS Sale',         'url'=>'/stockpro/pages/pos.php',                 'roles'=>['admin','cashier']],
        'products'       => ['icon'=>'bi-box-seam',         'label'=>'Products',         'url'=>'/stockpro/pages/products.php',            'roles'=>['admin','stock']],
        'purchases'      => ['icon'=>'bi-truck',            'label'=>'Purchases',        'url'=>'/stockpro/pages/purchases.php',           'roles'=>['admin','stock']],
        'customers'      => ['icon'=>'bi-person-lines-fill','label'=>'Customers',        'url'=>'/stockpro/pages/customers.php',           'roles'=>['admin','cashier']],
        'expenses'       => ['icon'=>'bi-wallet2',          'label'=>'Expenses',         'url'=>'/stockpro/pages/expenses.php',            'roles'=>['admin','cashier']],
        'cash_register'  => ['icon'=>'bi-cash-coin',        'label'=>'Cash Register',    'url'=>'/stockpro/pages/cash_register.php',       'roles'=>['admin','cashier']],
        'reports'        => ['icon'=>'bi-bar-chart-line',   'label'=>'Reports',          'url'=>'/stockpro/pages/reports.php',             'roles'=>['admin']],
        'suppliers'      => ['icon'=>'bi-people',           'label'=>'Suppliers',        'url'=>'/stockpro/pages/suppliers.php',           'roles'=>['admin','stock']],
        'amenities'      => ['icon'=>'bi-boxes',            'label'=>'Amenities',        'url'=>'/stockpro/pages/amenities.php',           'roles'=>['admin','stock']],
        'purchase_orders'=> ['icon'=>'bi-clipboard-check',  'label'=>'Purchase Orders',  'url'=>'/stockpro/pages/purchase_orders.php',     'roles'=>['admin','stock']],
        'returns'        => ['icon'=>'bi-arrow-return-left','label'=>'Returns',          'url'=>'/stockpro/pages/returns.php',             'roles'=>['admin','cashier','stock']],
        'wastage'        => ['icon'=>'bi-trash3',            'label'=>'Wastage',          'url'=>'/stockpro/pages/wastage.php',             'roles'=>['admin','stock']],
        'audits'         => ['icon'=>'bi-clipboard2-check',  'label'=>'Audits',           'url'=>'/stockpro/pages/audits.php',              'roles'=>['admin']],
        'users'          => ['icon'=>'bi-people-fill',      'label'=>'Users',            'url'=>'/stockpro/pages/users.php',               'roles'=>['admin']],
        'settings'       => ['icon'=>'bi-gear',             'label'=>'Settings',         'url'=>'/stockpro/pages/settings.php',            'roles'=>['admin']],
        'backup'         => ['icon'=>'bi-cloud-arrow-up',   'label'=>'Backup',           'url'=>'/stockpro/pages/backup.php',              'roles'=>['admin']],
    ];

    $logo = file_exists($_SERVER['DOCUMENT_ROOT'] . '/stockpro/assets/img/logo.png')
        ? '<img src="/stockpro/assets/img/logo.png" alt="logo" style="height:38px;width:38px;object-fit:contain;border-radius:50%;border:2px solid rgba(255,255,255,.3)" class="me-2">'
    ...
    echo '<nav class="navbar navbar-expand-lg navbar-dark px-3 no-print" style="background:linear-gradient(135deg,var(--brand-dark) 0%,var(--brand) 100%);box-shadow:0 2px 12px rgba(0,0,0,.4)">
        <a class="navbar-brand fw-bold d-flex align-items-center flex-shrink-0" href="/stockpro/">'
        . $logo
        ...
        <div class="d-flex align-items-center gap-2 flex-shrink-0 ms-auto ms-lg-0 order-lg-last">
            ...
            <a href="/stockpro/logout.php" class="btn btn-sm btn-outline-light py-0 px-2" title="Sign out">
...
<script src="/stockpro/assets/js/pos.js"></script>
</body></html>';
}
